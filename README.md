# Restaurant-Page #
This is one of the Intermediate JavaScript Projects provided by "The Odin Project".
This project utilizes Webpack functionality and the use of the Module system. This
